...
fn flag2colours(flag: &str) -> Vec<Rgb> {                     //  {{{1
  ...
  match f {
    ...
    "agender"     => vec![Rgb(0, 0, 0), Rgb(185, 185, 185),
                          Rgb(255, 255, 255), Rgb(184, 244, 131)],
    "aromantic"   => vec![Rgb(61, 165, 66), Rgb(167, 211, 121),
                          Rgb(255, 255, 255), Rgb(169, 169, 169),
                          Rgb(0, 0, 0)],
    "asexual"     => vec![Rgb(0, 0, 0), Rgb(163, 163, 163),
                          Rgb(255, 255, 255), Rgb(128, 0, 128)],
    "bisexual"    => vec![Rgb(214, 2, 112), Rgb(214, 2, 112), Rgb(0, 56, 168),
                          Rgb(155, 79, 150), Rgb(155, 79, 150)],
    "genderfluid" => vec![Rgb(255, 117, 162), Rgb(255, 255, 255),
                          Rgb(190, 24, 214), Rgb(0, 0, 0), Rgb(51, 62, 189)],
    "genderqueer" => vec![Rgb(181, 126, 220), Rgb(181, 126, 220),
                          Rgb(255, 255, 255), Rgb(255, 255, 255),
                          Rgb(74, 129, 35), Rgb(74, 129, 35)],
    "lesbian"     => vec![Rgb(163, 2, 98), Rgb(211, 98, 164),
                          Rgb(255, 255, 255), Rgb(255, 154, 86),
                          Rgb(213, 45, 0)],
    "nonbinary"   => vec![Rgb(255, 244, 48), Rgb(255, 255, 255),
                          Rgb(156, 89, 209), Rgb(0, 0, 0)],
    "pansexual"   => vec![Rgb(33, 177, 255), Rgb(33, 177, 255),
                          Rgb(255, 216, 0), Rgb(255, 216, 0),
                          Rgb(255, 33, 140), Rgb(255, 33, 140)],
    "polysexual"  => vec![Rgb(246, 28, 185), Rgb(246, 28, 185),
                          Rgb(7, 213, 105), Rgb(7, 213, 105),
                          Rgb(28, 146, 246), Rgb(28, 146, 246)],
    "transgender" => vec![Rgb(91, 206, 250), Rgb(245, 169, 184),
                          Rgb(255, 255, 255), Rgb(245, 169, 184),
                          Rgb(91, 206, 250)],
