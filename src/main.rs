...
fn flag2colours(flag: &str) -> Vec<Rgb> {                     //  {{{1
  ...
  match f {
    ...
    "bisexual"    => vec![Rgb(214, 2, 112), Rgb(0, 56, 168),
                          Rgb(155, 79, 150)],
    "genderfluid" => vec![Rgb(255, 117, 162), Rgb(255, 255, 255),
                          Rgb(190, 24, 214), Rgb(0, 0, 0), Rgb(51, 62, 189)],
    "genderqueer" => vec![Rgb(181, 126, 220), Rgb(255, 255, 255),
                          Rgb(74, 129, 35)],
    ...
    "pansexual"   => vec![Rgb(33, 177, 255), Rgb(255, 216, 0),
                          Rgb(255, 33, 140)],
    "polysexual"  => vec![Rgb(246, 28, 185), Rgb(7, 213, 105),
                          Rgb(28, 146, 246)],
